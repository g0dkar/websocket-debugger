...
public class CoberturaClient extends JFrame implements ActionListener {
	...
	public CoberturaClient(String defaultlocation) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == chatField) {
			...
			try {
				...
				headers.put("cobertura", "acompanhe-a-cobertura-de-tudo-que-acontece-em-teresina-agora");
				cc = new WebSocketClient(new URI(uriField.getText()), (Draft) draft.getSelectedItem(), headers, 10000) {
